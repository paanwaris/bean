...
```{r plot-thinning-results, fig.width=10, fig.height=5}
...
```{r calibrate-bean-1, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r calibrate-bean-2, warning=FALSE, message=FALSE}
