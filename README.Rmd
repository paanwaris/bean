...
This complete workflow demonstrates how `bean` can be used to make a data-driven, transparent, and reproducible choice about thinning parameters, strengthening the scientific validity of subsequent modeling efforts.
