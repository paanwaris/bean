...
> See the [Preparing bean](https://paanwaris.github.io/bean/articles/data-preparation.html)
> vignette.
...
> See the [Finding the environmental resolution](https://paanwaris.github.io/bean/articles/environmental-thinning.html)
> vignette.
...
-   Deterministic (`thin_env_center`): Generates a new point at the
    exact center of every occupied grid cell.

> See the [Apply thinning](https://paanwaris.github.io/bean/articles/environmental-thinning.html)
> vignette.
...
> See the [Niche delineation](https://paanwaris.github.io/bean/articles/niche-modeling.html)
> vignette.
...
> See the [Prediction and mapping](https://paanwaris.github.io/bean/articles/niche-modeling.html)
> vignette.
